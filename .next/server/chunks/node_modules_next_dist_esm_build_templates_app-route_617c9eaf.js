...
}`,a=`I'm looking for an AI tool with the following preferences:
${t?`- Query: ${t}`:""}
${s?`- Use case: ${s}`:""}
${n?`- Budget: ${n}`:""}
${r?`- Category: ${r}`:""}

Please recommend the best tools from your list that match these needs.`;if(!process.env.OPENAI_API_KEY)throw Error("OPENAI_API_KEY not set");let o=new n$({apiKey:process.env.OPENAI_API_KEY}),l=await o.chat.completions.create({model:"gpt-3.5-turbo",messages:[{role:"system",content:i},{role:"user",content:a}],temperature:.7,max_tokens:1e3}),c=l.choices[0]?.message?.content||"{}";try{let e=JSON.parse(c);return eH.NextResponse.json(e)}catch(e){return eH.NextResponse.json({rawResponse:c,message:c})}}catch(e){if(e instanceof n$.APIError){if(401===e.status)return eH.NextResponse.json({error:"Invalid API key. Please check your configuration."},{status:401});if(429===e.status)return eH.NextResponse.json({error:"Rate limit exceeded. Please try again later."},{status:429})}return eH.NextResponse.json({error:"Failed to get recommendations. Please try again."},{status:500})}}e.s(["POST",()=>nR,"dynamic",0,"force-dynamic"],74484);var nI=e.i(74484);let nO=new eI.AppRouteRouteModule({definition:{kind:eO.RouteKind.APP_ROUTE,page:"/api/recommend/route",pathname:"/api/recommend",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/recommend/route.ts",nextConfigOutput:"",userland:nI}),{workAsyncStorage:nk,workUnitAsyncStorage:nE,serverHooks:nP}=nO;function nC(){return(0,ek.patchFetch)({workAsyncStorage:nk,workUnitAsyncStorage:nE})}async function nT(e,t,s){nO.isDev&&(0,eE.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/recommend/route";n=n.replace(/\/index$/,"")||"/";let r=await nO.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!r)return t.statusCode=400,t.end("Bad Request"),null==s.waitUntil||s.waitUntil.call(s,Promise.resolve()),null;let{buildId:i,params:a,nextConfig:o,parsedUrl:l,isDraftMode:c,prerenderManifest:u,routerServerContext:h,isOnDemandRevalidate:d,revalidateOnlyGenerated:p,resolvedPathname:f,clientReferenceManifest:m,serverActionsManifest:g}=r,y=(0,eT.normalizeAppPath)(n),w=!!(u.dynamicRoutes[y]||u.routes[f]),_=async()=>((null==h?void 0:h.render404)?await h.render404(e,t,l,!1):t.end("This page could not be found"),null);if(w&&!c){let e=!!u.routes[f],t=u.dynamicRoutes[y];if(t&&!1===t.fallback&&!e){if(o.experimental.adapterPath)return await _();throw new eF.NoFallbackError}}let b=null;!w||nO.isDev||c||(b="/index"===(b=f)?"/":b);let v=!0===nO.isDev||!w,x=w&&!v;g&&m&&(0,eC.setManifestsSingleton)({page:n,clientReferenceManifest:m,serverActionsManifest:g});let S=e.method||"GET",$=(0,eP.getTracer)(),A=$.getActiveScopeSpan(),R={params:a,prerenderManifest:u,renderOpts:{experimental:{authInterrupts:!!o.experimental.authInterrupts},cacheComponents:!!o.cacheComponents,supportsDynamicResponse:v,incrementalCache:(0,eE.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:o.cacheLife,waitUntil:s.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,s,n,r)=>nO.onRequestError(e,t,n,r,h)},sharedContext:{buildId:i}},I=new eN.NodeNextRequest(e),O=new eN.NodeNextResponse(t),k=ej.NextRequestAdapter.fromNodeNextRequest(I,(0,ej.signalFromNodeResponse)(t));try{let r=async e=>nO.handle(k,R).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let s=$.getRootSpanAttributes();if(!s)return;if(s.get("next.span_type")!==eM.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${s.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=s.get("next.route");if(r){let t=`${S} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${S} ${n}`)}),i=!!(0,eE.getRequestMeta)(e,"minimalMode"),a=async a=>{var l,f;let m=async({previousCacheEntry:o})=>{try{if(!i&&d&&p&&!o)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await r(a);e.fetchMetrics=R.renderOpts.fetchMetrics;let l=R.renderOpts.pendingWaitUntil;l&&s.waitUntil&&(s.waitUntil(l),l=void 0);let c=R.renderOpts.collectedTags;if(!w)return await (0,eL.sendResponse)(I,O,n,R.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,eB.toNodeOutgoingHttpHeaders)(n.headers);c&&(t[eq.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let s=void 0!==R.renderOpts.collectedRevalidate&&!(R.renderOpts.collectedRevalidate>=eq.INFINITE_CACHE)&&R.renderOpts.collectedRevalidate,r=void 0===R.renderOpts.collectedExpire||R.renderOpts.collectedExpire>=eq.INFINITE_CACHE?void 0:R.renderOpts.collectedExpire;return{value:{kind:eU.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:s,expire:r}}}}catch(t){throw(null==o?void 0:o.isStale)&&await nO.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,eD.getRevalidateReason)({isStaticGeneration:x,isOnDemandRevalidate:d})},!1,h),t}},g=await nO.handleResponse({req:e,nextConfig:o,cacheKey:b,routeKind:eO.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:u,isRoutePPREnabled:!1,isOnDemandRevalidate:d,revalidateOnlyGenerated:p,responseGenerator:m,waitUntil:s.waitUntil,isMinimalMode:i});if(!w)return null;if((null==g||null==(l=g.value)?void 0:l.kind)!==eU.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==g||null==(f=g.value)?void 0:f.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});i||t.setHeader("x-nextjs-cache",d?"REVALIDATED":g.isMiss?"MISS":g.isStale?"STALE":"HIT"),c&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,eB.fromNodeOutgoingHttpHeaders)(g.value.headers);return i&&w||y.delete(eq.NEXT_CACHE_TAGS_HEADER),!g.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,eW.getCacheControlHeader)(g.cacheControl)),await (0,eL.sendResponse)(I,O,new Response(g.value.body,{headers:y,status:g.value.status||200})),null};A?await a(A):await $.withPropagatedContext(e.headers,()=>$.trace(eM.BaseServerSpan.handleRequest,{spanName:`${S} ${n}`,kind:eP.SpanKind.SERVER,attributes:{"http.method":S,"http.target":e.url}},a))}catch(t){if(t instanceof eF.NoFallbackError||await nO.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,eD.getRevalidateReason)({isStaticGeneration:x,isOnDemandRevalidate:d})},!1,h),w)throw t;return await (0,eL.sendResponse)(I,O,new Response(null,{status:500})),null}}e.s(["handler",()=>nT,"patchFetch",()=>nC,"routeModule",()=>nO,"serverHooks",()=>nP,"workAsyncStorage",()=>nk,"workUnitAsyncStorage",()=>nE],60098)}];

//# sourceMappingURL=node_modules_next_dist_esm_build_templates_app-route_617c9eaf.js.map