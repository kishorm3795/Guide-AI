...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    alternatives: ['Midjourney', 'Leonardo AI', 'DALL-E 3', 'FLUX.1', 'Stable Diffusion'],
    averageRating: 4.7,
    reviewCount: 98,
    lastUpdated: 'Today'
  },
  {
    ...
    alternatives: ['Midjourney', 'DALL-E 3', 'Leonardo AI', 'FLUX.1', 'Ideogram'],
    averageRating: 4.8,
    reviewCount: 456,
    lastUpdated: 'Today'
  },
  ...
  },
  {
    ...
    alternatives: ['Synthesia', 'Elai.io', 'Colossyan', 'DeepBrain', 'Runway ML'],
    averageRating: 4.7,
    reviewCount: 210,
    lastUpdated: 'Today'
  },
  ...
  },
  {
    ...
    alternatives: ['Suno AI', 'MusicGen', 'AIVA', 'Soundraw', 'Mubert'],
    averageRating: 4.8,
    reviewCount: 367,
    lastUpdated: 'Today'
  }
